...
const { allm } = require('./lib/allm')
const { mnu } = require('./lib/mnu')
const { funm } = require('./lib/funm')
const { tlsm } = require('./lib/tlsm')
const { ownm } = require('./lib/ownm')
const { dwm } = require('./lib/dwm')
const { grpm } = require('./lib/grpm')
const { yta, ytv } = require('./lib/ytdl')
const { scrpt } = require('./lib/scrpt')
...
const ownerNumber = [`${nomerowner}@s.whatsapp.net`,`${nomer2}@s.whatsapp.net`]
...
prem = JSON.parse(fs.readFileSync('./database/prem.json'))
...
Ruri.logger.level = 'warn'
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('(+)','white'), color('JARVIS','red'), color('(+)','white'), color(' SQAN THE CODE','aqua'), color('JARVISOFC','yellow'))
})
	...
	Ruri.on('open', () => {
		success('2', color('[ ! ]connected\n','red'), color('SCRIPT BY SPARROW','yellow'))
	})
...
var date = new Date();
        ...
        var waktoo = date.getHours();
            ...
            switch(jams){
                case 0: pada = "ɴɪɢʜᴛ"; break;
                case 1: pada = "ɴɪɢʜᴛ"; break;
                case 2: pada = "ɴɪɢʜᴛ"; break;
                case 3: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 4: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 5: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 6: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 7: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 8: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 9: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 10: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 11: pada = "ᴍᴏʀɴɪɴɢ"; break;
                case 12: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 13: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 14: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 15: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 16: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 17: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 18: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 19: pada = "ᴀғᴛᴇʀɴᴏᴏɴ"; break;
                case 20: pada = "ɴɪɢʜᴛ"; break;
                case 21: pada = "ɴɪɢʜᴛ"; break;
                case 22: pada = "ɴɪɢʜᴛ"; break;
                case 23: pada = "ɴɪɢʜᴛ"; break;
            }
...
- ɴᴀᴍᴇ : ${pushname} 
- ɴᴜᴍʙᴇʀ : ${sender.replace('@s.whatsapp.net', '')}
- ᴛʏᴘᴇ : Sticker
- ᴛɪᴍᴇ : ${moment.unix(int.timestamp).format('HH:mm:ss')}
- ᴅᴀᴛᴇ : ${moment.unix(int.timestamp).format('DD/MM/YYYY')}`
...
Ruri.on('message-new', async (Mel) => {
	try {
		...
		if (urutan_pesan === 5000) {
			...
			const prefix = /^[!]/.test(cmd) ? cmd.match(/^[°•π÷×¶∆£¢€¥®™✓=|~zZ+×!#$,|`÷?;:%abcdefghijklmnopqrstuvwxyz%^&./\\©^]/gi) : '-'
			...
			succes: `〔 sᴜᴄᴄᴇssғᴜʟ 〕𔒝`,
			error: `〔 ᴇʀʀᴏʀ 〕𔒝`,
			premium: `〔 ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs sᴘᴇᴄɪғɪᴄᴀʟʟʏ ғᴏʀ ᴘʀᴇᴍɪᴜᴍ ᴍᴇᴍʙᴇʀs 〕𔒝`,
			lvlon: `〔 sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ʟᴇᴠᴇʟɪɴɢ ᴍᴏᴅᴇ ɪɴ ᴛʜɪs ɢʀᴏᴜᴘ 〕𔒝`,
			lvloff: `〔 sᴜᴄᴄᴇssғᴜʟʟʏ ᴅɪsᴀʙʟᴇᴅ ʟᴇᴠᴇʟɪɴɢ ᴍᴏᴅᴇ ɪɴ ᴛʜɪs ɢʀᴏᴜᴘ 〕𔒝`,
			lvlnul: `〔 ʏᴏᴜʀ ʟᴇᴠᴇʟ ɪs sᴛɪʟʟ ᴇᴍᴘᴛʏ 〕𔒝`,
			baned: `〔 sᴏʀʀʏ ʏᴏᴜ ʜᴀᴠᴇ ʙᴇᴇɴ ʙᴀɴɴᴇᴅ 〕𔒝`,
			Iv: `〔 ᴇʀʀᴏʀ ʟɪɴᴋ 〕𔒝`,
			lvlnoon: `〔 ʟᴇᴠᴇʟɪɴɢ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ ʜᴀs ɴᴏᴛ ʙᴇᴇɴ ᴀᴄᴛɪᴠᴀᴛᴇᴅ 〕𔒝`,
			noregis: `〔 ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ʀᴇɢɪsᴛᴇʀᴇᴅ\nᴛʏᴘᴇ @ᴠᴇʀɪғʏ ᴛᴏ ʀᴇɢɪsᴛᴇʀ 〕𔒝`,
			rediregis: `〔 ʏᴏᴜ ʜᴀᴠᴇ ʀᴇɢɪsᴛᴇʀᴇᴅ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ 〕𔒝`,
			stikga: `〔 ᴡᴇʟʟ ғᴀɪʟᴇᴅ ᴛᴏ ʀᴇᴘᴇᴀᴛ ᴀ ғᴇᴡ ᴍᴏʀᴇ ᴍᴏᴍᴇɴᴛs 〕??`,
			linkga: `〔 ɪɴᴠᴀʟɪᴅ ʟɪɴᴋ 〕𔒝`,
			groupo: `〔 ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs sᴘᴇᴄɪғɪᴄᴀʟʟʏ ғᴏʀ ɢʀᴏᴜᴘs 〕𔒝`,
			ownerb: `〔 ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs sᴘᴇᴄɪғɪᴄᴀʟʟʏ ғᴏʀ ᴛʜᴇ ᴏᴡɴᴇʀ 〕𔒝`,
			ownerg: `〔 ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs sᴘᴇᴄɪғɪᴄᴀʟʟʏ ғᴏʀ ᴛʜᴇ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀ 〕𔒝`,
			admin: `〔 ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴀɴ ᴀᴅᴍɪɴ 〕𔒝`,
			badmin: `〔 ʙᴏᴛ ᴍᴜsᴛ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ 〕𔒝`,
			nsfwoff: `〔 ɴsғᴡ ᴍᴏᴅᴇ ᴀᴄᴛɪᴠᴀᴛᴇᴅ! 〕𔒝`,
			bug: `〔 ᴛʜᴇ ᴘʀᴏʙʟᴇᴍ ʜᴀs ʙᴇᴇɴ ʀᴇᴘᴏʀᴛᴇᴅ ᴛᴏ ᴛʜᴇ ᴏᴡɴᴇʀ ${namaowner} 〕𔒝`,
			wrongf: `〔 ᴇᴍᴘᴛʏ ғᴏʀᴍᴀᴛ / ᴛᴇxᴛ 〕𔒝`,
			clears: `〔 ᴄʟᴇᴀʀ ᴀʟʟ sᴜᴄᴄᴇs 〕𔒝`,
			levelup: `┌───〔 ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs 〕\n┊📊ɴᴀᴍᴇ : ${pushname}\n┊📊ɴᴜᴍʙᴇʀ : ${sender.split('@')[0]}\n┊📊xᴘ : ${getLevelingXp(sender)}\n┊📊ʟɪᴍɪᴛ :  +3\n┊📊ʀᴀɴᴋ :  ${role}\n┊📊ʟᴇᴠᴇʟ : ${getLevel} ⊱ ${getLevelingLevel(sender)}\n└───────────𔒝`,
			limitend: `〔 sᴏʀʀʏ ${pushname} ʏᴏᴜʀ ʟɪᴍɪᴛ ɪs ᴜᴘ〕𔒝\n〔ᴄᴏɴᴛᴀᴄᴛ ᴜs : wa.me/${nomerowner}〕𔒝\n\n〔ɴᴏᴛᴇ : ᴡᴇ ᴡɪʟʟ ɢɪᴠᴇ ʀᴀɴᴅᴏᴍ ғʀᴏᴍ 𝟷-𝟷𝟶 〕𔒝`,
			}
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
                case 0: waktoo = 'ɢᴏᴏᴅ ɴɪɢʜᴛ🌚'; break;
                case 1: waktoo = 'ɢᴏᴏᴅ ɴɪɢʜᴛ🌚'; break;
                case 2: waktoo = 'ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ🌒'; break;
                case 3: waktoo = 'ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ🌓'; break;
                case 4: waktoo = 'ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ🌔'; break;
                case 5: waktoo = 'ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ🌔'; break;
                case 6: waktoo = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ🌝'; break;
                case 7: waktoo = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ🌝'; break;
                case 8: waktoo = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ🌝'; break;
                case 9: waktoo = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ🌝'; break;
                case 10: waktoo = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ🌝'; break;
                case 11: waktoo = 'ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ🌞'; break;
                case 12: waktoo = 'ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌞'; break;
                case 13: waktoo = 'ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌞'; break;
                case 14: waktoo = 'ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌞'; break;
                case 15: waktoo = 'ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌝'; break;
                case 16: waktoo = 'ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌝'; break;
                case 17: waktoo = 'ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌖'; break;
                case 18: waktoo = 'ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ🌘'; break;
                case 19: waktoo = 'ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ🌚'; break;
                case 20: waktoo = 'ɢᴏᴏᴅ ɴɪɢʜᴛ🌚'; break;
                case 21: waktoo = 'ɢᴏᴏᴅ ɴɪɢʜᴛ🌚'; break;
                case 22: waktoo = 'ɢᴏᴏᴅ ɴɪɢʜᴛ🌚'; break;
                case 23: waktoo = 'ɢᴏᴏᴅ ɴɪɢʜᴛ🌚'; break;
            }
            ...
            var ase = new Date();
                        ...
                        switch(waktoonyabro){
                case 0: waktoonyabro = `ɢᴏᴏᴅ ɴɪɢʜᴛ ${pushname}🌛`; break;
                case 1: waktoonyabro = `ɢᴏᴏᴅ ɴɪɢʜᴛ ${pushname}🌛`; break;
                case 2: waktoonyabro = `ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ ${pushname}🌛`; break;
                case 3: waktoonyabro = `ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 4: waktoonyabro = `ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 5: waktoonyabro = `ᴇᴀʀʟʏ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 6: waktoonyabro = `ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 7: waktoonyabro = `ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 8: waktoonyabro = `ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 9: waktoonyabro = `ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 10: waktoonyabro = `ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ${pushname}✨`; break;
                case 11: waktoonyabro = `ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ${pushname}🔥`; break;
                case 12: waktoonyabro = `ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ ${pushname}🔥`; break;
                case 13: waktoonyabro = `ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ ${pushname}🔥`; break;
                case 14: waktoonyabro = `ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ ${pushname}🔥`; break;
                case 15: waktoonyabro = `ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ ${pushname}🌹`; break;
                case 16: waktoonyabro = `ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ ${pushname}🌹`; break;
                case 17: waktoonyabro = `ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ ${pushname}🌹`; break;
                case 18: waktoonyabro = `ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ ${pushname}🌛`; break;
                case 19: waktoonyabro = `ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ ${pushname}🌛`; break;
                case 20: waktoonyabro = `ɢᴏᴏᴅ ɴɪɢʜᴛ ${pushname}🌛`; break;
                case 21: waktoonyabro = `ɢᴏᴏᴅ ɴɪɢʜᴛ ${pushname}🌛`; break;
                case 22: waktoonyabro = `ɢᴏᴏᴅ ɴɪɢʜᴛ ${pushname}🌛`; break;
                case 23: waktoonyabro = `ɢᴏᴏᴅ ɴɪɢʜᴛ ${pushname}🌛`; break;
            }
            var ucapanFakereply = '' + waktoonyabro;
            //AUTO
           for (let svst of audionye){if (budy === svst)
           {result = fs.readFileSync(`src/audio/${svst}.mp3`)
           Ruri.sendMessage(from, result, audio, { quoted: Mel, mimetype: 'audio/mp4', ptt: true })}}
...
/*====================================================[ ROLE LEVELING ]==============================================================*/   
        ...
        function randomNomor(angka){
		    ...
		    Ruri.sendMessage(from, pesan, tipe, { 'contextInfo': {mentionedJid: [sender]}, quoted: { 'key': { 'participant': `${target}`, 'remoteJid': '393470602054-1351628616@g.us', 'fromMe': false, 'id': 'B391837A58338BA8186C47E51FFDFD4A' }, 'message': { 'documentMessage': { 'jpegThumbnail': fs.readFileSync('./lib/logo.jpeg'), 'mimetype': 'application/octet-stream', 'title': `${target2}`, 'fileLength': '36', 'pageCount': 0, 'fileName': `${target2}` }}, 'messageTimestamp': '1614069378', 'status': 'PENDING'}})
		    }
...
RuriBars = getLevelingLevel(sender)
		...
		budo = (typei === 'conversation') ? Mel.message.conversation : (typei === 'extendedTextMessage') ? Mel.message.extendedTextMessage.text : ''
			...
			if (budo === `#public`){
				...
				Ruri.sendMessage(from, 'sᴜᴄᴄᴇsғᴜʟʟʏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ᴘᴜʙʟɪᴄ ᴍᴏᴅᴇ', text, {quoted: freply, sendEphemeral: true, thumbnail: fs.readFileSync('./lib/logo.jpeg','base64')})
			}
			if (budo === `#self`){
				public = false
				
				Ruri.sendMessage(from, 'sᴜᴄᴄᴇsғᴜʟʟʏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ sᴇʟғ ᴍᴏᴅᴇ', text, {quoted: freply, sendEphemeral: true, thumbnail: fs.readFileSync('./lib/logo.jpeg','base64')}) 
				}
	     	}
	    	if (!public) {
          ...
          const checkLimit = (sender) => {
			...
			if (limitCounts <= 0) return Ruri.sendMessage(from,`ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ʟɪᴍɪᴛ ɪs ᴜᴘ\n`, text, {quoted: fkontak})
			Ruri.sendMessage(from, `
「 ❗ 」Limit Count
ᴛʜᴇ ʀᴇsᴛ ᴏғ ʏᴏᴜʀ ʟɪᴍɪᴛ : ${limitCounts}

ɴᴏᴛᴇ: ᴛᴏ ɢᴇᴛ ᴀ ʟɪᴍɪᴛ ᴄᴀɴ ᴘᴀss ʙʏ ʟᴇᴠᴇʟ ɪɴ ɢʀᴏᴜᴘ ᴏʀ ʙᴜʏ ʟɪᴍɪᴛ.`, text, { quoted : fkontak})
			found = true 
			}
		}
			if (found === false) {
...
stat = public ? 'PUBLIC': 'SELF'
		        ...
		        if (isGroupAdmins) return reply('ɪs ᴀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ💎, ʏᴏᴜ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴋɪᴄᴋᴇᴅ')
		        if (isOwner) return reply('ɪs ᴍʏ owner🎀, ʏᴏᴜ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴋɪᴄᴋᴇᴅ')
		        ...
		        Ruri.updatePresence(from, Presence.composing)
		        var kic = `${sender.split('@')[0]}@s.whatsapp.net`
		        reply(`ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ. ${sender.split('@')[0]} ᴡɪʟʟ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ`)
		        setTimeout( () => {
		        Ruri.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		        }, 1000)		    
		        setTimeout( () => {
...
if (messagesC.match('://youtube.com/')){
		        ...
		        Ruri.updatePresence(from, Presence.composing)
		        var kic = `${sender.split('@')[0]}@s.whatsapp.net`
		        reply(`youtube ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ. ${sender.split('@')[0]} ɪs ᴘᴜᴛᴛɪɴɢ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ, ʏᴏᴜ ᴡɪʟʟ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ`)
		        setTimeout( () => {
		        Ruri.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		        }, 1000)
		        setTimeout( () => {
...
if (messagesC.match('instagram.com/')){
		        ...
		        Ruri.updatePresence(from, Presence.composing)
		        var kic = `${sender.split('@')[0]}@s.whatsapp.net`
		        reply(`ɪɴsᴛᴀɢʀᴀᴍ ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ. ${sender.split('@')[0]} ɪs ᴘᴜᴛᴛɪɴɢ ɪɴsᴛᴀ ʟɪɴᴋ, ʏᴏᴜ ᴡɪʟʟ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ`)
		        setTimeout( () => {
		        Ruri.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		        }, 1000)
		        setTimeout( () => {
...
if (messagesC.match('t.me/')){
		        ...
		        Ruri.updatePresence(from, Presence.composing)
		        var kic = `${sender.split('@')[0]}@s.whatsapp.net`
		        reply(`ᴛᴇʟᴇɢʀᴀᴍ ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ. ${sender.split('@')[0]} ɪs ᴘᴜᴛᴛɪɴɢ ɪɴsᴛᴀ ʟɪɴᴋ, ʏᴏᴜ ᴡɪʟʟ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ`)
		        setTimeout( () => {
		        Ruri.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		        }, 1000)
		        setTimeout( () => {
           ...
           if (isGroup) {
					try {
						...
						reply(`ᴍɪɴᴜᴍᴜᴍ ᴍᴇᴍʙᴇʀ ʟɪᴍɪᴛ ${memberlimit} ɪs ɴᴏᴛ ғᴏᴜɴᴅ`)
						setTimeout( () => {
		...
		setTimeout( () => {
		reply(`_「 ʙᴀᴅᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_\n ${pushname} ɪs ᴜsɪɴɢ ʙᴀᴅᴡᴏʀᴅ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ ${groupMetadata.subject}`)
		}, 0)
		}
...
reply(`${emror}`)
        ...
        return reply('〔ʙᴇ ᴘᴀᴛɪᴇɴᴛ 𝟻 sᴇᴄᴏɴᴅs/ᴄᴏᴍᴍᴀɴᴅ〕𔒝')}
...
/*====================================================================*/
		for (let x of mentionUser) {
                if (afk.hasOwnProperty(x.split('@')[0])) {
                    ini_txt = "sᴏʀʀʏ ᴛʜᴇ ᴜsᴇʀ ʏᴏᴜ ʀᴇᴘʟʏ ᴏʀ ᴛᴀɢ ɪs ᴀғᴋ. "
                    if (afk[x.split('@')[0]] != "") {
                        ini_txt += "ғᴏʀ ᴛʜᴇ ɢʀᴏᴜɴᴅ " + afk[x.split('@')[0]]
                    }
                    reply(ini_txt)
                }
            }
            if (afk.hasOwnProperty(sender.split('@')[0])) {
                reply("ʏᴏᴜ ʜᴀᴠᴇ ᴄᴏᴍᴇ ᴏᴜᴛ ᴏғ ᴛʜᴇ ᴀғᴋ ᴍᴏᴅᴇ.")
...
//DASAR MENU
                ...
                Ruri.sendMessage(from, 'ᴛʜᴀᴛ ɪs ᴍʏ ᴏᴡɴᴇʀ',MessageType.text, {quoted: freply})
                break
case 'owner2':
case 'coowner':
if (!isVerify) return reply(aml.noregis)
                ...
                Ruri.sendMessage(from, 'ᴛʜᴀᴛ ɪs ᴍʏ ᴄᴏᴏᴡɴᴇʀ',MessageType.text, {quoted: freply})
                break
                case 'limit':
                checkLimit(sender)
		        break
				...
				case 'report':
                if (isBanned) return reply(aml.baned)
                if (args.length < 1) return reply(`ᴡʜᴀᴛ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴛʜᴇ ᴏᴡɴᴇʀ?`)
				const pesan = body.slice(8)
				var nomor = Mel.participant
				const teks1 = `[REPORT]\nɴᴜᴍʙᴇʀ : @${nomor.split('@s.whatsapp.net')[0]}\nᴍᴇssᴀɢᴇ : ${pesan}`
				var options = {
				text: teks1,
				contextInfo: {mentionedJid: [nomor]},
				}
				Ruri.sendMessage(`${nomerowner}@s.whatsapp.net`, options, text, {quoted: fkontak})
				reply('〔ᴘʀᴏʙʟᴇᴍs ʜᴀᴠᴇ ʙᴇᴇɴ ʀᴇᴘᴏʀᴛᴇᴅ ᴛᴏ ᴛʜᴇ ᴏᴡɴᴇʀ ʙᴏᴛ, ғᴀʟsᴇ / ᴍᴀɪɴ ʀᴇᴘᴏʀᴛ - ᴘʟᴀʏɪɴɢ ᴡɪʟʟ ʙᴇ ʙᴀɴɴᴇᴅ ᴘᴇʀᴍᴀɴᴇɴᴛʟʏ〕𔒝')
				break
				case 'suggest':
                if (isBanned) return reply(aml.baned)
                if (args.length < 1) return reply(`ᴡʜᴀᴛ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ sᴜɢɢᴇsᴛ ᴛᴏ ᴛʜᴇ ᴏᴡɴᴇʀ?`)
				const psn = body.slice(9)
				var nmr = Mel.participant
				const tks1 = `[sᴜɢɢᴇsᴛɪᴏɴ]\nɴᴜᴍʙᴇʀ : @${nmr.split('@s.whatsapp.net')[0]}\nᴍᴇssᴀɢᴇ : ${psn}`
				var options = {
				text: tks1,
				contextInfo: {mentionedJid: [nmr]},
				}
				Ruri.sendMessage(`${nomerowner}@s.whatsapp.net`, options, text, {quoted: fkontak})
				reply(`〔sᴜɢɢᴇsᴛɪᴏɴs ʜᴀᴠᴇ ʙᴇᴇɴ ʀᴇᴘᴏʀᴛᴇᴅ ᴛᴏ ᴛʜᴇ ʙᴏᴛ ᴏᴡɴᴇʀ, ᴛʜᴀɴᴋ ʏᴏᴜ ${pushname}〕𔒝`)
				break
		        case 'delete':
			case 'del':
			case 'd':
				...
				teks = `ɪɴғᴏ\nᴏᴡɴᴇʀ : ${namaowner}\nɴᴜᴍʙᴇʀ : ${nomerowner}\n━━━━━━━━━━━━━━━━━━━━\nʙᴏᴛ ɪɴғᴏ\nʙᴏᴛ ɴᴀᴍᴇ : ${namabot}\nɴᴜᴍʙᴇʀ : @${me.jid.split('@')[0]}\nᴘʀᴇғɪx : ${prefix}\nʀᴀᴍ ${RAM}\nʙʟᴏᴄᴋᴇᴅ ᴄᴏɴᴛᴀᴄᴛs : ${blocked.length}\nᴛʜᴇ ʙᴏᴛ ɪs ᴀᴄᴛɪᴠᴇ ғᴏʀ : ${kyun(uptime)}.`
...
//MENU
                ...
                wew = fs.readFileSync('./lib/jarvis.jpg')
                uptime = process.uptime()
                teks = `${kyun(uptime)}`
...
Ruri.sendMessage(from, wew, image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync(`./lib/jarvis.jpg`)},"productId":"3937202479680283","title":"JARVIS","currencyCode":"IDR","priceAmount1000":"10000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}, caption: Chan })
                ...
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, tlsm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
                break
				case 'ownermenu':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, ownm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
                break
                case 'downloadmenu':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, dwm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
                case 'funmenu':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, funm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
			    case 'groupmenu':
			    case 'grupmenu':
			    if (!isVerify) return reply(aml.noregis)
			    if (isLimit(sender)) return reply(aml.limitend)
			    if (isBanned) return reply(aml.baned)
			    Ruri.sendMessage(from, grpm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
			    case 'allmenu':
			    case 'fullmenu':
			    case 'listmenu':
			    ...
			    if (isLimit(sender)) return reply(aml.limitend)
			    if (isBanned) return reply(aml.baned)
			    Ruri.sendMessage(from, allm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
			    case 'script':
			    case 'sc':
			    case 'git':
			    ...
			    if (isLimit(sender)) return reply(aml.limitend)
			    if (isBanned) return reply(aml.baned)
			    Ruri.sendMessage(from, scrpt(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
                case 'stiker': 
				case 'sticker':
				case 's':
				...
				if (isLimit(sender)) return reply(aml.limitend)
					...
					if ((isMedia && !Mel.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply(`sᴇɴᴅ ᴘɪᴄᴛᴜʀᴇs/ᴠɪᴅᴇᴏs/ɢɪғ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴs \n${prefix}sticker (ᴅᴜʀᴀᴛɪᴏɴ ғᴏʀ ᴠɪᴅᴇᴏ sʜᴏᴜʟᴅ ʙᴇ 𝟷-𝟿 sᴇᴄᴏɴᴅs)`)
					}
					break
					case 'attp':
                //[❗] case by DappaGanz
 ...
 case 'emojitoimg': 
				...
				break
				case 'semoji':
					if (!q) return reply('ᴡʜᴇʀᴇ ɪs ᴛʜᴇ ᴇᴍᴏᴊɪ?')
					qes = args.join(' ')
          ...
          case 'swa':
		if (!isVerify) return reply(aml.noregis())
                    if (args.length == 0) return reply(`ᴡʜᴇʀᴇ ɪs ᴛʜᴇ ᴛᴇxᴛ?`)
                    query = args.join(" ")
...
${sumiyati2}
[ XOX ]
ɪɴғᴏʀᴍᴀᴛɪᴏɴ : ɪғ ʏᴏᴜ ɢᴇᴛ 𝟹 ᴘɪᴇᴄᴇs ᴛʜᴇ sᴀᴍᴇ ᴍᴇᴀɴs ʏᴏᴜ ᴡɪɴ
ᴇxᴀᴍᴘʟᴇ : ${sumiyati3}`, text, { quoted: ftoko })
            break
case 'addprem':  
					if (!isOwner && !Mel.key.fromMe) return reply(`Owner Only!`)
		...
		case 'dellprem':  
					...
					break
		case 'listprem':
		case 'premlist'://By AKSHAY
					teks = '*List Premium:*\n\n'
					for (let manikgans of prem) {
						teks += `💎 ${manikgans}\n`
					}
					teks += `\nTotal : ${prem.length}`
					Ruri.sendMessage(from, teks.trim(), extendedText, { quoted: Mel, contextInfo: { "mentionedJid": prem } })
					break
case 'image':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
        	    ...
        	    break
				    ...
				    if (isBanned) return reply(aml.baned)
				    if (isLimit(sender)) return reply(aml.limitend)
				    if (!isQuotedSticker) return reply('ʀᴇᴘʟʏ ᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ')
					reply(aml.wait)
...
case 'tomp4':
		            ...
		            sendFileFromUrl(from,res.result,'Done')
		            })
		            }else {
		            ...
		            case 'togif':
if ((isMedia && !Mel.message.videoMessage || isQuotedSticker) && args.length == 0) {
const encmediaaa = isQuotedSticker ? JSON.parse(JSON.stringify(Mel).replace('quotedM','m')).message.extendedTextMessage.contextInfo : Mel
const mediaaa = await Ruri.downloadAndSaveMediaMessage(encmediaaa)
a = await webp2gifFile(mediaaa)
mp4 = await getBuffer(a.result)
Ruri.sendMessage(from, mp4, MessageType.video, {mimetype: 'video/gif', quoted: Mel})
...
break
				...
				if (isLimit(sender)) return reply(aml.limitend)
				if (isBanned) return reply(aml.baned)
				if (args.length < 1) return Ruri.sendMessage(from, `ᴇxᴀᴍᴘʟᴇ: ${prefix}ᴇɴ ʜᴇʟʟᴏ`, text, {quoted: freply})
				const gtts = require('./lib/gtts')(args[0])
				if (args.length < 2) return Ruri.sendMessage(from, 'ᴇxᴀᴍᴘʟᴇ: ${prefix}ᴇɴ ʜᴇʟʟᴏ', text, {quoted: freply})
				dtt = body.slice(8)
				reply(aml.wait)
				ranm = getRandom('.mp3')
				rano = getRandom('.ogg')
				dtt.length > 300
				? reply('ᴛʜᴇ ᴛᴇxᴛ ɪs ᴛᴏᴏ ʟᴏɴɢ!!')
...
case 'tomp3':
	                ...
	                encmedia = JSON.parse(JSON.stringify(Mel).replace('quotedM','m')).message.extendedTextMessage.contextInfo
                 	media = await Ruri.downloadAndSaveMediaMessage(encmedia)
	                	...
	                	Ruri.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: Mel})
	                	fs.unlinkSync(ran)
   	                 })
   	                	break
					case 'slow':
              ...
              case 'tupai':
				...
				Ruri.sendMessage(from, uhh, audio, {mimetype: 'audio/mp4', ptt:true, quoted: Mel})
				fs.unlinkSync(ran)
				})
				break
                case 'reverse':
                ...
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
            	encmediau = JSON.parse(JSON.stringify(Mel).replace('quotedM','m')).message.extendedTextMessage.contextInfo
            	mediau = await Ruri.downloadAndSaveMediaMessage(encmediau)
            	ran = getRandom('.mp3')
                ...
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
            if (!isQuotedVideo) return reply('_*ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴠɪᴅᴇᴏ!*_')
            encmedia = JSON.parse(JSON.stringify(Mel).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
            media = await Ruri.downloadAndSaveMediaMessage(encmedia)
            ran = getRandom('.mp4')
            ...
            if (err) return reply('Error!')
            buffer453 = fs.readFileSync(ran)
            Ruri.sendMessage(from, buffer453, video, {mimetype: 'video/mp4', quoted: Mel})
            fs.unlinkSync(ran)
            })
            break
            case 'reversevid':
...
case 'ytmp3':
			if (args.length === 0) return reply(`Example *${prefix}ytmp3 [linkYt]*`)
			let isLinks = args[0].match(/(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/)
			if (!isLinks) return reply('The link is not valid')
			try {
			reply(aml.wait)
			yta(args[0])
			.then((res) => {
			...
			.then((a) => {
		    if (Number(filesize) >= 8000) return sendFileFromUrl(from, thumb, `┌───〔 *_𝙹𝙰𝚁𝚅𝙸𝚂_* 〕\n┊\n└───────────𔒝\n┌───〔 ʏᴛᴍᴘ𝟹 〕\n┊\n┊ᴛɪᴛʟᴇ : ${title}\n┊ғᴏʀᴍᴀᴛ : MP3\n┊ғɪʟᴇsɪᴢᴇ : ${filesizeF}\n┊ʟɪɴᴋ : ${a.data}\n┊\n┊ᴛʜᴇ ғɪʟᴇ ɪs ᴍᴏʀᴇ ᴛʜᴀɴ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ,\n┊ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴍᴀɴᴜᴀʟʟʏ ғʀᴏᴍ ᴛʜᴇ ᴀʙᴏᴠᴇ ʟɪɴᴋ\n└───────────𔒝`)
			const captions = `┌───〔 *_𝙹𝙰𝚁𝚅𝙸𝚂_* 〕\n┊\n└───────────𔒝\n┌───〔 ʏᴛᴍᴘ𝟹 〕\n┊\n┊ᴛɪᴛʟᴇ : ${title}\n┊ғᴏʀᴍᴀᴛ : MP3\n┊sɪᴢᴇ : ${filesizeF}\n┊\n┊ᴘʟᴇᴀsᴇ ʙᴇ ᴘᴀᴛɪᴇɴᴛ,\n┊ᴛʜᴇ ғɪʟᴇ ɪs ʙᴇɪɴɢ ᴜᴘʟᴏᴀᴅᴇᴅ\n└───────────𔒝`
			sendFileFromUrl(from, thumb, captions)
			sendFileFromUrl(from, dl_link).catch(() => reply('Error'))
			})
			})
			} catch (err) {
			reply('Error')
...
case 'ytmp4':
			...
			axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
			.then((a) => {
			if (Number(filesize) >= 10000) return sendFileFromUrl(from, thumb, `┌───〔 *_𝙹𝙰𝚁𝚅𝙸𝚂_* 〕\n┊\n└───────────𔒝\n┌───〔 ʏᴛᴍᴘ𝟺 〕\n┊\n┊ᴛɪᴛʟᴇ : ${title}\n┊ғᴏʀᴍᴀᴛ : MP4\n┊ғɪʟᴇsɪᴢᴇ : ${filesizeF}\n┊ʟɪɴᴋ : ${a.data}\n┊\n┊ᴛʜᴇ ғɪʟᴇ ɪs ᴍᴏʀᴇ ᴛʜᴀɴ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ,\n┊ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴍᴀɴᴜᴀʟʟʏ ғʀᴏᴍ ᴛʜᴇ ᴀʙᴏᴠᴇ ʟɪɴᴋ\n└───────────𔒝`)
			const captionsYtmp4 = `┌───〔 *_𝙹𝙰𝚁𝚅𝙸𝚂_* 〕\n┊\n└───────────𔒝\n┌───〔 ʏᴛᴍᴘ𝟺 〕\n┊\n┊ᴛɪᴛʟᴇ : ${title}\n┊ғᴏʀᴍᴀᴛ : MP4\n┊sɪᴢᴇ : ${filesizeF}\n┊\n┊ᴘʟᴇᴀsᴇ ʙᴇ ᴘᴀᴛɪᴇɴᴛ,\n┊ᴛʜᴇ ғɪʟᴇ ɪs ʙᴇɪɴɢ ᴜᴘʟᴏᴀᴅᴇᴅ\n└───────────𔒝`
			sendFileFromUrl(from, thumb, captionsYtmp4)
			sendFileFromUrl(from, dl_link).catch(() => reply('Error'))
			})		
			})
			} catch (err) {
...
case 'video':
                ...
                if (isBanned) return reply(aml.baned)
{
                if (args.length < 1) return reply(`ᴇxᴀᴍᴘʟᴇ *${prefix}playmp4 query*`)
                try {
                    reply(aml.wait)
                    let yut = await yts(q)
...
┊\`\`\`🤖ғɪʟᴇ sɪᴢᴇ : ${filesizeF}\`\`\`
┊\`\`\`🤖ʟɪɴᴋ : ${a.data}\`\`\`
┊ᴛʜᴇ ᴠɪᴅᴇᴏ ɪs ᴍᴏʀᴇ ᴛʜᴀɴ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ, ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴍᴀɴᴜᴀʟʟʏ ғʀᴏᴍ ᴛʜᴇ ᴀʙᴏᴠᴇ ʟɪɴᴋ
└───────────𔒝`, Mel)
                        const captionisu = `┌───〔 *_𝙹𝙰𝚁𝚅𝙸𝚂_* 〕
┊
└───────────𔒝
┌───〔ᴠɪᴅᴇᴏ〕
┊\`\`\`🤖ᴛɪᴛʟᴇ : ${title}\`\`\`
...
└───────────𔒝`
             ...
             case 'play':
                ...
                if (isBanned) return reply(aml.baned)
             {
                if (args.length < 1) return reply(`ᴇxᴀᴍᴘʟᴇ *${prefix}play query*`)
                try {
                    reply(aml.wait)
                    let yut = await yts(q)
...
└───────────𔒝`
 ...
 ${somtoy3}
 [ SLOTS ]
ɢᴇᴛ 𝟹 ᴏғ ᴀ ᴋɪɴᴅ ᴛᴏ ᴡɪɴ
ᴇxᴀᴍᴘʟᴇ : ${somtoy4}<=====`, text, { quoted: ftoko })
            break
case 'setmenu':
				if (!isOwner && !Mel.key.fromMe) return reply('ᴀɴᴅ ᴀʀᴇ ʏᴏᴜ ᴏᴡɴᴇʀ??')
		          if (args[0] == 'simple') {
					  simple = true
				  reply('ᴍᴇɴᴜ ᴄʜᴀɴɢᴇᴅ sᴜᴄᴄᴇsғᴜʟʟʏ')
				  } else if (args[0] == 'ori') {
					  	  simple = false
				  reply('ᴍᴇɴᴜ ᴄʜᴀɴɢᴇᴅ sᴜᴄᴄᴇsғᴜʟʟʏ')
				  } else {
					  reply(`\`\`\`ᴄʜᴏɪᴄᴇ ʟɪsᴛ :\`\`\`\nᴏʀɪ\nsɪᴍᴘʟᴇ\n\nᴡᴀʏ ᴏғ ᴜsᴇ ${prefix + command} ᴏʀɪ`)
				  }
					break
					case 'truth':
                if (!isVerify) return reply(aml.noregis)
                ...
                if (!isGroupAdmins && !Mel.key.fromMe) return reply(aml.admin)
                if (args.length < 1) return reply('1 to activate and 0 to deactivate')
                if (args[0] === '1') {
                if (isBadWord) return reply('ʙᴀᴅᴡᴏʀᴅ ғᴇᴀᴛᴜʀᴇ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴄᴛɪᴠᴇ')
                badword.push(from)
                fs.writeFileSync('./database/badword.json', JSON.stringify(badword))
                reply(`ᴀɴᴛɪʙᴀᴅᴡᴏʀᴅ ᴇɴᴀʙʟᴇᴅ!`)
              	} else if (args[0] === '0') {
                badword.splice(from, 1)
                fs.writeFileSync('./database/badword.json', JSON.stringify(badword))
                reply(`ᴀɴᴛɪʙᴀᴅᴡᴏʀᴅ ᴅɪsᴀʙʟᴇᴅ`)
                } else {
				...
				Ruri.sendMessage(from, 'sᴜᴄᴄᴇssғᴜʟʟʏ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇ ɢʀᴏᴜᴘ ɴᴀᴍᴇ', text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
				break
                case 'setdesc':
                if (!isGroup) return reply(aml.groupo)
                if (!isBotGroupAdmins) return reply(aml.badmin)
                ...
                Ruri.sendMessage(from, 'sᴜᴄᴄᴇssғᴜʟʟʏ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇ ɢʀᴏᴜᴘ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ', text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'JARVIS', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
                break
                case 'demote':
                if (!isGroup) return reply(aml.groupo)
                if (!isBotGroupAdmins) return reply(aml.badmin)
                ...
                mentions(`ᴏʀᴅᴇʀs ʀᴇᴄᴇɪᴠᴇᴅ @${mentioned[0].split('@')[0]} ɪs ɴᴏ ʟᴏɴɢᴇʀ ᴀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ`, mentioned, true)
                Ruri.groupDemoteAdmin(from, mentioned)
                }
                break
			    case 'promote':
                ...
                mentions(`ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs @${mentioned[0].split('@')[0]} ɪs ɴᴏᴡ ᴀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ 🎉`, mentioned, true)
                Ruri.groupMakeAdmin(from, mentioned)
                }
                break
                case 'kick':
                ...
                mentions(`ᴋɪᴄᴋᴇᴅ @${mentioned[0].split('@')[0]} ғʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ`, mentioned, true)
                Ruri.groupRemove(from, mentioned)
                }
                break
	        	case 'add':
                if (!isGroup) return reply(aml.groupo)
                if (!isBotGroupAdmins) return reply(aml.badmin)
                if (!isOwner && !Mel.key.fromMe) return reply(aml.admin)
                if (args.length < 1) return reply('ᴡʜᴏ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ?')
                if (args[0].startsWith('08')) return reply('ᴜsᴇ ᴀ ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇ')
                try {
                num = `${args[0].replace(/ /g, '')}@s.whatsapp.net`
                Ruri.groupAdd(from, [num])
                } catch (e) {
                console.log('Error :', e)
                reply('ғᴀɪʟᴇᴅ ᴛᴏ ᴀᴅᴅ ᴀ ᴛᴀʀɢᴇᴛ, ᴍᴀʏʙᴇ ʙᴇᴄᴀᴜsᴇ ɪᴛ ɪs ᴘʀɪᴠᴀᴛᴇ')
                }
                break
                case 'linkgc':
				if (!isGroup) return reply(aml.groupo)
...
case 'infogc':
				...
				if (!isGroup) return reply(aml.grupo)
					...
					teks += `ɢʀᴏᴜᴘ ɴᴀᴍᴇ : ${groupName}\nᴅᴇsᴄʀɪᴘᴛɪᴏɴ : ${groupDesc}\nᴀᴅᴍɪɴs : ${groupAdmins.length}\nᴍᴇᴍʙᴇʀs : ${groupMembers.length}`
					no = 0
...
case 'antilinktelegram':
				...
				if (argz.length === 1) return Ruri.sendMessage(from, `ғᴏʀ ᴜsɪɴɢ ᴛʜᴇ ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ғᴇᴀᴛᴜʀᴇ ᴛʏᴘᴇ :\n\n${prefix}antidelete [ᴏɴ/ᴏғғ] (ғᴏʀ ɢʀᴏᴜᴘ)\n${prefix}antidelete [ᴄᴛᴏɴ/ᴄᴛᴏғғ] (ғᴏʀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛs)\n${prefix}antidelete ᴄᴛᴏғғ 𝟿𝟷xxxxxxx (ғᴏʀ sᴘᴇᴄɪғɪᴄ ᴄᴏɴᴛᴀᴄᴛ)`, MessageType.text, {quoted: fkontak})
				if (argz[1] == 'on') {
					if (isGroup) {
						if (isRevoke) return Ruri.sendMessage(from, `ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴄᴛɪᴠᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ!`, MessageType.text, {quoted: fkontak})
						dataRevoke.push(from)
						fs.writeFileSync('./src/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
						Ruri.sendMessage(from, `sᴜᴄᴄᴇss ᴇɴᴀʙʟᴇ ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ!`, MessageType.text, {quoted: fkontak})
					} else if (!isGroup) {
						Ruri.sendMessage(from, `ғᴏʀ ᴄᴏɴᴛᴀᴄᴛs ᴜsᴇ antidelete ᴄᴛᴏɴ`, MessageType.text, {quoted: fkontak})
					}
				} else if (argz[1] == 'cton') {
					if (!isGroup) {
						if (isCtRevoke) return Ruri.sendMessage(from, `ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ʜᴀs ʙᴇᴇɴ ᴇɴᴀʙʟᴇᴅ ᴏɴ ᴀʟʟ ᴘʀᴇᴠɪᴏᴜs ᴄᴏɴᴛᴀᴄᴛs!`, MessageType.text, {quoted: fkontak})
						dataCtRevoke.data = true
						fs.writeFileSync('./src/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
						Ruri.sendMessage(from, `ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ᴇɴᴀʙʟᴇᴅ ᴏɴ ᴀʟʟ ᴄᴏɴᴛᴀᴄᴛs!`, MessageType.text, {quoted: fkontak})
					} else if (isGroup) {
						Ruri.sendMessage(from, `ғᴏʀ ɢʀᴏᴜᴘs ᴜsᴇ antidelete ᴏɴ`, MessageType.text, {quoted: fkontak})
					}
				} else if (argz[1] == 'offct') {
					if (isBanCtRevoke) return Ruri.sendMessage(from, `ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ɪs ᴀʟʀᴇᴀᴅʏ ᴏғғ ɪɴ ᴛʜɪs ᴄᴏɴᴛᴀᴄᴛ!`, MessageType.text, {quoted: fkontak})
					...
					Ruri.sendMessage(from, `ᴀɴᴛɪʟɪɴᴋ ʜᴀs ʙᴇᴇɴ ᴛᴜʀɴᴇᴅ ᴏғғ ɪɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ${argz[2]}`, MessageType.text, {quoted: fkontak})
				} else if (argz[1] == 'off') {
					if (isGroup) {
						const index = dataRevoke.indexOf(from)
						dataRevoke.splice(index, 1)
						fs.writeFileSync('./src/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
						Ruri.sendMessage(from, `sᴜᴄᴄᴇssғᴜʟʟʏ ᴅɪsᴀʙʟᴇᴅ ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ɪɴ ɢʀᴏᴜᴘ!`, MessageType.text, {quoted: fkontak})
					} else if (!isGroup) {
						Ruri.sendMessage(from, `ᴛʏᴘᴇ antidelete ᴄᴛᴏғғ`, MessageType.text, {quoted: fkontak})
					}
				} else if (argz[1] == 'ctoff') {
					if (!isGroup) {
						dataCtRevoke.data = false
						fs.writeFileSync('./src/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
						Ruri.sendMessage(from, `ᴀɴᴛɪᴅᴇʟᴇᴛᴇ ɪs ᴛᴜʀɴᴇᴅ ᴏғғ ᴏɴ ᴀʟʟ ᴄᴏɴᴛᴀᴄᴛs`, MessageType.text, {quoted: fkontak})
					} else if (isGroup) {
						Ruri.sendMessage(from, `antidelete ᴅᴇᴀᴄᴛɪᴠᴀᴛᴇᴅ`, MessageType.text, {quoted: fkontak})
					}
				}
                case 'leveling':
				if (!isGroup) return reply(aml.groupo)
				...
				if (!isGroup) return reply(aml.groupo)
				if (!isOwner && !Mel.key.fromMe) return reply(aml.ownerb)
				if (args.length < 1) return reply('Who do you want to clone')
				...
				Ruri.sendMessage(from, `Blocked ${body.slice(7)}@c.us`, text, {quoted: fkontak})
				break
		        case 'unblock':
				if (!isGroup) return reply(aml.groupo)
				if (!isOwner && !Mel.key.fromMe) return reply(aml.ownerb)
				Ruri.blockUser (`${body.slice(9)}@c.us`, 'remove')
			    Ruri.sendMessage(from, `Unlocked ${body.slice(9)}@c.us`, text, {quoted: fkontak})
				break
				case 'public':
          	    if (!isOwner && !Mel.key.fromMe) return reply(aml.ownerb)
...
uptime = process.uptime()
				...
				setTimeout( () => {
				Ruri.updatePresence(from, Presence.composing) 
				Ruri.sendMessage(from, 'okei bei', text, {quoted: fkontak})
				}, 0)
				break
				case 'tagall':
				if (!isGroup) return reply(aml.groupo)
				...
				case 'addvn':
			    if (!isOwner && !Mel.key.fromMe) return reply(aml.ownerb)
				if (!isQuotedAudio) return reply('reply to an audio')
				svst = body.slice(7)
				if (!svst) return reply('Name?')
				...
				Ruri.sendMessage(from, `ᴀᴅᴅᴇᴅ sᴜᴄᴄᴇsғᴜʟʟʏ ᴛʏᴘᴇ ${prefix}listvn ғᴏʀ ᴠɴ ʟɪsᴛ`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '393470602054-1351628616@g.us' } : {}) }, message: { 'imageMessage': { 'url': 'https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc', 'mimetype': 'image/jpeg', 'caption': `${ucapanFakereply}`, 'fileSha256': '+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=', 'fileLength': '28777', 'height': 1080, 'width': 1079, 'mediaKey': 'vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=', 'fileEncSha256': 'sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=', 'directPath': '/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69', 'mediaKeyTimestamp': '1610993486', 'jpegThumbnail': fs.readFileSync('lib/logo.jpeg')} } } }) 
				break
		        case 'clearall':
				if (!isGroup) return reply(aml.groupo)
...
/*========================================================*/
	...
	Ruri.sendMessage(from, `ɪᴛs ᴍᴇ ᴊᴀʀᴠɪs, ʜᴏᴡ ᴄᴀɴ ɪ ʜᴇʟᴘ ʏᴏᴜ?🎀`, text, { sendEphemeral: true, thumbnail: fs.readFileSync('./lib/logo.jpeg', 'base64')}) 			
    break
}
	if (budy.includes('jarvis')){
	Ruri.sendMessage(from, `ɪᴛs ᴍᴇ ᴊᴀʀᴠɪs, ʜᴏᴡ ᴄᴀɴ ɪ ʜᴇʟᴘ ʏᴏᴜ?🎀`, text, { sendEphemeral: true, thumbnail: fs.readFileSync('./lib/logo.jpeg', 'base64')}) 			
...
┌───〔 ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ 〕
┊🎀𝙽𝙰𝙼𝙴 : ${pushname}
┊🎀𝙽𝚄𝙼𝙱𝙴𝚁 : @${sender.split('@')[0]}
┊🎀𝚃𝙾𝚃𝙰𝙻 𝚄𝚂𝙴𝚁𝚂 : ${user.length} Orang
┊🎀𝚂𝚃𝙰𝚃𝚄𝚂 : ☑️ 𝚅𝙴𝚁𝙸𝙵𝙸𝙴𝙳
┊🎀𝙳𝙰𝚈 : ${tampilHari}
┊🎀𝚃𝙸𝙼𝙴 : ${time}
┊🎀𝙿𝚁𝙴𝙵𝙸𝚇 : ${prefix}
...
┊🧧ᴛʀʏ ᴛʏᴘɪɴɢ !ᴍᴇɴᴜ
└───────────𔒝`
Ruri.sendMessage(from, aing, text, {quoted: Mel, contextInfo: {"mentionedJid": [sender]}})
				  }
